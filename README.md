...
<!-- CONTRIB:START -->
#### Contributing to
- **[Printing Press](https://github.com/mvanhorn/cli-printing-press)** [![GitHub stars](https://img.shields.io/github/stars/mvanhorn/cli-printing-press?style=flat&color=gold)](https://github.com/mvanhorn/cli-printing-press) - Created and contributed three CLIs for the Printing Press library.
- **[Paperclip CLI](https://printingpress.dev/library/project-management/paperclip-self-hosted)** - Agent-native CLI, skill, and MCP server for self-hosted Paperclip.
- **[Zillow CLI](https://printingpress.dev/library/other/zillow)** - Housing-market CLI and MCP server using Zillow Research datasets, with local SQLite sync, data-quality checks, and explainable market analysis.
- **[OpenSky CLI](https://printingpress.dev/library/travel/opensky)** - Free live aircraft tracker for the OpenSky Network's public ADS-B data. No account or key: bounding-box live states, airport departures, full trajectory replay, and offline SQLite sync.
<!-- CONTRIB:END -->
