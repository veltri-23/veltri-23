...
- **[DietrichGebert/ponytail#686](https://github.com/DietrichGebert/ponytail/pull/686)** [![GitHub stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=gold)](https://github.com/DietrichGebert/ponytail) - fix(hooks): validate PONYTAIL_SUBAGENT_MATCHER before compiling
...
- **[block/buzz#4742](https://github.com/block/buzz/pull/4742)** [![GitHub stars](https://img.shields.io/github/stars/block/buzz?style=flat&color=gold)](https://github.com/block/buzz) - fix(workflow): honor enabled: false flag at execution time and persist it
- **[garrytan/gbrain#3776](https://github.com/garrytan/gbrain/pull/3776)** [![GitHub stars](https://img.shields.io/github/stars/garrytan/gbrain?style=flat&color=gold)](https://github.com/garrytan/gbrain) - Restores semantic takes retrieval by embedding active claims, wiring query vectors into think, and aligning vector dimensions with the configured embedder.
- **[garrytan/gbrain#3832](https://github.com/garrytan/gbrain/pull/3832)** [![GitHub stars](https://img.shields.io/github/stars/garrytan/gbrain?style=flat&color=gold)](https://github.com/garrytan/gbrain) - Fixes gbrain autopilot on Windows: resolves the CLI shim by walking PATH directly instead of the which command, with guards against cwd hijack, non-spawnable PATHEXT types, and directory shadowing.
